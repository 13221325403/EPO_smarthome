...
import epo.smarthome.iprotocol.IMsg;
...
public class Msg implements IMsg {
	...
	private byte[] id = new byte[0];// 16����MAC��ַ(8Byte),�豸��,����ǰ�油 0
	private int packLen;
	private int dataLen;
	private MSGCMDTYPE cmdType = MSGCMDTYPE.CMDTYPE_A0; // �������
	private MSGCMD cmd = MSGCMD.CMD00; // ����
	private boolean checkOk; // ��ȷ�ı���
	private boolean isACK; // ȷ�ϻش�
	private boolean isNoACK; // ���ϻش�
	private boolean isSponse; // �Ƿ���Ҫ�ظ�
	private MSGSTATE state;
	private short crc;
	private byte[] data;
	private byte[] deCode; // ���պ�ȥ������ı���
	private byte[] enCode; // ����ǰû��ת��ı���
	private byte[] recvData; // ���յ�������
	private byte[] sendData; // Ҫ���͵�����
	private String[] result; // ��ʼ���Դ洢���ݵĲ��� ������cmdTYpe ��cmd �������ַ��������

	private byte[] torken = new byte[0];// ͨ�����ƣ���¼�ɹ�����д��ֶ�,��һ�ֽڱ�ʾ����
	private int info = 0; // 2���ֽ� ��չ��Ϣ ������ţ����ܵ�������չ
